<div class="d-flex flex-column flex-shrink-0 p-3 rounded" style="position: sticky; top: 0; bottom:100%; min-height:100vh; min-width:220px; max-width: 280px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
