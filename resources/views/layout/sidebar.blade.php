<div class="d-flex flex-column flex-shrink-0 p-3 rounded" style="position: sticky; top: 0; min-width:220px; max-width: 280px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
  ...
  <div class="dropdown">
    <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
      <img src="{{asset('img/user-2.png')}}" alt="" width="32" height="32" class="rounded-circle me-2">
